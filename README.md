...
- 默认运行时间：周一/三/四/五 北京时间 10:00，周二 12:00
...
```yaml
schedule:
  - cron: '0 2 * * 1,3,4,5'  # 周一、三、四、五 UTC 02:00 = 北京时间 10:00
  - cron: '0 4 * * 2'        # 周二 UTC 04:00 = 北京时间 12:00
```

cron 格式：`分 时 日 月 星期`（星期：0=周日, 1=周一, ...）

常用示例：
- `0 0 * * *` = 每天 UTC 00:00 = 北京时间 08:00
- `0 2 * * 1-5` = 周一至周五 UTC 02:00 = 北京时间 10:00
